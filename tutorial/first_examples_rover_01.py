...
from suqc.parameter.parameter import Parameter, LatinHyperCubeSampling
...
if __name__ == "__main__":  # main required by Windows to run in parallel
    ...
    parameter_vadere_only = [Parameter("speedDistributionMean", range=[1.3, 1.6]),
    ...
    parameter = [ Parameter("speedDistributionMean", simulator="vadere", range=[1.3,1.6]) ,
